...
<!-- Collect the nav links, forms, and other content for toggling -->
	...
	<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="/home">الصفحة الرئيسية</a> / <span>لتواصل معنا</span></h3>
		</div>
	</div>
	<!--banner-->
	<!--contact-->
				...
				<div class="container">
					<div class="contact-grids">
						<div class="col-md-6 contact-left">
							<img src="images/acco.jpg" width="500" height="400" class="img-responsive" alt=""/>
						</div>
						<div class="col-md-6 contact-right">
							...
							<ul>
								...
								<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>General Pvt 66, Dong Da Hanoi, Vietnam.</li>
							</ul>
						</div>
						<div class="clearfix"></div>
						...
						<p>Suspendisse id erat sit amet ante interdum suscipit eget sed quam. In aliquet pulvinar nisi vitae dignissim. Aenean at libero neque, non ultricies turpis.
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel.</p>
					</div>
					<!---------------------------------------------------------------------------><-->
					<div class="contact-form">
						...
						<form action="#" method="post">
							...
							<input type="mail" value="Email" name="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
		...
		<!--footer-->
					...
					<div class="copy-section">
						<div class="container">
							<p>&copy; 2016 Home Plat. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
						</div>
					</div>
				<!--copy-->
				<!--signin-->
